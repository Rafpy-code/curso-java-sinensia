...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		// ***************** Saber si un String contiene un determinado substring ****************
		...
		// Como convertir un String a un número (int, double)
		
		String strImporte = "5600.0";
		String strNumeroPuertas = "4";
				
		double importe = Double.parseDouble(strImporte);
		int numeroPuertas = Integer.parseInt(strNumeroPuertas);
